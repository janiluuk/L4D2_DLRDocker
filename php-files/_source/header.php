		...
		<meta name="design" content="Left4Dead2 - DLR Matrix edition!">
	...
	<body>
		...
		<div id="mySidebar" class="sidebar">
			...
			<div class="container mobile_submenu">
				...
				<?php if ($gameserver == "enabled"): ?><a href="<?php echo $site_statsurl;?>gameserver"><i class="fa fa-server"></i> Server status</a><?php endif; ?>
		...
		<div class="content text-center text-md-left" style="background-color: #CCC;">
			<div class="container text-left">
				<br />
				<div class="rounded-0">
					<div class="row d-flex align-items-center">
						<div class="col-md-5 col-lg-6 text-center text-md-left mb-4 mb-md-0">
							<span>
						...
						<br/>
                                                <div class="col-md-5 col-lg-4 text-center text-md-right">
                                                        <a class="btn rounded-0 btn-main" href="https://ws.remidi.net/#index-server:98114beeebdeae497b0bd5001d7ab80e" target="_blank" role="button"><i class="fa fa-steam-square"></i> RCON Webadmin</a>
		...
		<div class="content text-center text-md-left" style="background-color: #DDD;">
			<div class="container text-left">
