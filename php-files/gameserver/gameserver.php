...
if ($server1_ip == "") { }
	...
	if ($online == "Online") {
		...
		echo "<iframe src=\"https://ws.remidi.net/#index-server:bdb89a33666901d6849738b841d17750\" width=100% height=400></iframe>";
...
if ($server3_ip == "") { }
	...
	else { echo "<tr><td data-title=\"Server:\">3</td><td data-title=\"Status:\"><span style=\"color: red;\">Offline</span></td><td data-title=\"IP:\">$server3_ip:$server3_port</td><td data-title=\"Hostname:\">-</td><td data-title=\"Player:\">-</td><td data-title=\"Map:\">-</td><td data-title=\"Settings:\">-</td><td data-title=\"Connect:\">-<td data-title=\"Logs:\"></td></tr>"; }
}
...
if ($server4_ip == "") { }
	...
	if ($online == "Online") {
		...
		$maxplayers = read_server_val_tmp_gq_maxplayers($server, 'gq_maxplayers');
		$mapname = read_server_val_tmp_gq_mapname($server, 'gq_mapname');
		echo "<tr><td data-title=\"Server:\">4</td><td data-title=\"Status:\"><span style=\"color: green;\">Online</span></td><td data-title=\"IP:\">$server4_ip:$server4_port</td><td data-title=\"Hostname:\">$hostname</td><td data-title=\"Player:\">$numplayers / $maxplayers</td><td data-title=\"Map:\">$mapname</td><td class=\"text-left\" data-title=\"Settings:\"><button type=\"button\" data-toggle=\"modal\" class=\"btn btn-no\" data-target=\"#$server\"><i class=\"fa fa-cogs\"></i></button></td><td class=\"text-left\"> <div data-title=\"Connect:\" onclick=\"window.location='steam://connect/$server4_ip:$server4_port'\" style=\"cursor:pointer;float:left\" data-placement=\"bottom\"><button type=\"button\" data-toggle=\"modal\" class=\"btn btn-no\"><i class=\"fa fa-sign-in\"></i></button></div><div style=\"float:right;display:inline;margin-right:20px\">";
		echo "</td></tr>";
	...
	else { echo "<tr><td data-title=\"Server:\">4</td><td data-title=\"Status:\"><span style=\"color: red;\">Offline</span></td><td data-title=\"IP:\">$server4_ip:$server4_port</td><td data-title=\"Hostname:\">-</td><td data-title=\"Player:\">-</td><td data-title=\"Map:\">-</td><td data-title=\"Settings:\">-</td><td data-title=\"Connect:\">-</td><td data-title=\"Settings:\">-</td></tr>"; }
}
