...
$servers = array(
	'Server1' => array('id' => 'Server1', 'type' => 'source', 'host' => $server1_ip.':'.$server1_port.''),
	'Server2' => array('id' => 'Server2', 'type' => 'source', 'host' => $server2_ip.':'.$server2_port.''),
	'Server3' => array('id' => 'Server3', 'type' => 'source', 'host' => $server3_ip.':'.$server3_port.''),
	'Server4' => array('id' => 'Server4', 'type' => 'source', 'host' => $server4_ip.':'.$server4_port.''),
        'Server5' => array('id' => 'Server5', 'type' => 'source', 'host' => $server2_ip.':'.$server2_port.''),
