...
========================================================================================
	Change Log:
1.7 (06-Jan-2021) - eyeonus
	- added sm_weapons_rot for direct console control of rotation
	- added sm_weapons_mov for direct console control of position
	- both new admin commands take two arguments, an axis and an amount to change
...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_weapon_spawn_rot",		CmdSpawnerRot,		ADMFLAG_ROOT, 	"Rotate weapon. Usage: !weapon_spawn_rot {x|y|z|} {degree}");
	...
	RegAdminCmd("sm_weapon_spawn_mov",		CmdSpawnerMov,		ADMFLAG_ROOT, 	"Move weapon. Usage: !weapon_spawn_mov {x|y|z} {distance}");
	RegAdminCmd("sm_weapon_spawn_load",		CmdLoadSpawns,		ADMFLAG_ROOT, 	"Load spawns after a reset");
	RegAdminCmd("sm_weapon_spawn_res",		CmdResetPlugin,		ADMFLAG_ROOT, 	"Reset plugin.");
...
public Action CmdLoadSpawns(int client, int args)
{
	LoadSpawns();
	return Plugin_Handled;
}

public Action CmdResetPlugin(int client, int args)
{
	ResetPlugin();
	return Plugin_Handled;
}
