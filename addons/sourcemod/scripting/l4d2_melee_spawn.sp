...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_melee_spawn_rot",		CmdSpawnerRot,		ADMFLAG_ROOT, 	"Rotate weapon. Usage: !weapon_spawn_rot {x|y|z|} {degree}");
	...
	RegAdminCmd("sm_melee_spawn_mov",		CmdSpawnerMov,		ADMFLAG_ROOT, 	"Move weapon. Usage: !weapon_spawn_mov {x|y|z} {distance}");
...
public Action CmdSpawnerRot(int client, int args)
{
	if(args < 2)
	{
		PrintToChat(client, "[SM] Usage: sm_melee_spawn_rot {x|y|z} {degree}");
		return Plugin_Handled;
	}
