...
public OnPluginStart()
{
	...
	cvarEnableSurvivor = CreateConVar("sm_hpregeneration_enablesurvivor", "1", "Enables regeneration for the Survivors (Def 1)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvarEnableBWHealing = CreateConVar("sm_hpregeneration_enablebwhealing", "1", "Enables regeneration for Survivors while they are Black and White (Def 1)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	cvarEnableTank = CreateConVar("sm_hpregeneration_enabletank", "0", "Enables regeneration for the Tank (Def 0)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	cvarBoomer = CreateConVar("sm_hpregeneration_boomer", "2", "Boomer Regeneration Mode (0 - Regenerate by %, 1 - Regenerate by Cvar, 2 - Regenerate by In-game Health)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarAmountBoomer = CreateConVar("sm_hpregeneration_boomeramount", "5", "Amount of life to heal per regeneration tick (Def 5)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarCharger = CreateConVar("sm_hpregeneration_charger", "2", "Charger Regeneration Mode (0 - Regenerate by %, 1 - Regenerate by Cvar, 2 - Regenerate by In-game Health)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarAmountCharger = CreateConVar("sm_hpregeneration_chargeramount", "5", "Amount of life to heal per regeneration tick (Def 5)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarJockey = CreateConVar("sm_hpregeneration_jockey", "2", "Jockey Regeneration Mode (0 - Regenerate by %, 1 - Regenerate by Cvar, 2 - Regenerate by In-game Health)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarAmountJockey = CreateConVar("sm_hpregeneration_jockeyamount", "5", "Amount of life to heal per regeneration tick (Def 5)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarHunter = CreateConVar("sm_hpregeneration_hunter", "2", "Hunter Regeneration Mode (0 - Regenerate by %, 1 - Regenerate by Cvar, 2 - Regenerate by In-game Health)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarSmoker = CreateConVar("sm_hpregeneration_smoker", "2", "Smoker Regeneration Mode (0 - Regenerate by %, 1 - Regenerate by Cvar, 2 - Regenerate by In-game Health)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarAmountSmoker = CreateConVar("sm_hpregeneration_smokeramount", "5", "Amount of life to heal per regeneration tick (Def 5)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarSpitter = CreateConVar("sm_hpregeneration_spitter", "2", "Boomer Regeneration Mode (0 - Regenerate by %, 1 - Regenerate by Cvar, 2 - Regenerate by In-game Health)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarAmountSpitter = CreateConVar("sm_hpregeneration_spitteramount", "5", "Amount of life to heal per regeneration tick (Def 5)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	cvarAmountTank = CreateConVar("sm_hpregeneration_tankamount", "0", "Amount of life to heal per regeneration tick (Def 0)", FCVAR_PLUGIN, true, 0.0, false, _);
	cvarPercentTank = CreateConVar("sm_hpregeneration_tankpercent", "0.0", "Amount of life to heal per regeneration tick (Def 0.0)", FCVAR_PLUGIN, true, 0.0, false, _);
