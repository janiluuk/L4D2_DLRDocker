...
{
	CreateConVar("afk_spectate_commands_version", PLUGIN_VERSION, "Lasersight plugin version", FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	...
	RegConsoleCmd("sm_joinspec", AFKTurnClientToSpectate);
	RegConsoleCmd("sm_jointeam1", AFKTurnClientToSpectate);
	
	RegConsoleCmd("sm_survivors", AFKTurnClientToSurvivors);
	RegConsoleCmd("sm_joinsurvivor", AFKTurnClientToSurvivors);
