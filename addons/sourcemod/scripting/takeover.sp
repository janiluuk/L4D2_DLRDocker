...
/*
	...
	Contributing programmer: eyal282
...
{
	name = PLUGIN_NAME,
	author = "Mikko Andersson (muukis), eyal282",
	description = PLUGIN_DESCRIPTION,
	version = PLUGIN_VERSION,
	url = "https://forums.alliedmods.net/showthread.php?p=2518921#post2518921"
};
...
public OnPluginStart()
{
	...
	CreateConVar("l4d_takeover_version", PLUGIN_VERSION, "Survivor Bot Takeover Version", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
...
stock bool:FormatTiers(Tiers[][])
{
	...
	for (new bot = 1; bot <= maxplayers; bot++)
	{
		...
		if(!IsClientTrapped(bot) && !TOIsClientIncapacitated(bot)) // Tier 0 - 3: Client is up and not trapped.
		{
			if(Health > 60)
			{
